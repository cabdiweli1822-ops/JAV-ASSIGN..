...
function showContact() {
  ...
  main.innerHTML = `
    ...
    <form id="contactForm" style="width:300px;margin:20px auto;display:flex;flex-direction:column;gap:10px">
  ...
  form.onsubmit = e => {
    ...
    if (name === "" || email === "") {
      error.textContent = "Fadlan buuxi magaca iyo emailka.";
      return;
    }
    if (!email.includes("@")) {
...
function showComplaintBox() {
  // STAGE 2: Complaint Box
  main.innerHTML = `
    <h2 style="text-align:center">Soo geli waxa ka cabaneeso</h2>
    <form id="complaintForm" style="width:300px;margin:20px auto;display:flex;flex-direction:column;gap:10px">
      <textarea id="complaint" placeholder="box yar..." style="height:100px"></textarea>
      <span id="compError" style="color:red;font-size:14px"></span>
      <button type="submit">Submit</button>
    </form>
  `;

  const form = document.getElementById("complaintForm");
  const error = document.getElementById("compError");
  ...
  form.onsubmit = e => {
    ...
    if (text === "") {
      error.textContent = "Fadlan cabashadaada qor.";
      return;
    }

    // Show Success Message Separately
    main.innerHTML = `
      <div style="
        max-width:400px;
        margin:50px auto;
        ...
        text-align:center;
      ">
        <h2 style="color:green">Waa Mahadsantahay!</h2>
        <p style="font-size:18px; color:#333; margin-top:15px">
          Waxan kaga soo jawaabi doonaa sida ugu dhaqsiyaha badan.
        </p>
